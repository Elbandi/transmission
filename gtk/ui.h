static const char * fallback_ui_file =
    ...
    "    <separator/>\n"
    "    <toolitem action='move-torrent-up'/>\n"
    "    <toolitem action='move-torrent-down'/>\n"
    "    <toolitem action='move-torrent-top'/>\n"
    "    <toolitem action='move-torrent-bottom'/>\n"
    "    <separator/>\n"
    ...
    "      <menuitem action='move-torrent-up'/>\n"
    "      <menuitem action='move-torrent-down'/>\n"
    "      <menuitem action='move-torrent-top'/>\n"
    "      <menuitem action='move-torrent-bottom'/>\n"
    "    </menu>\n"
    "    <separator/>\n"
    "    <menuitem action='verify-torrent'/>\n"
    "    <menuitem action='relocate-torrent'/>\n"
